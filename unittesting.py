...
class TestVehcile(unittest.TestCase):
    ...
    def test_update_vehicle(self):
        ...
        retrivedUpdatedVehicle = self.vehicle_service.GetVehicleByRegistrationNumber(
            "ASDF123"
        )
    ...
    def tearDown(self):
        try:
            retrivedVehicle = self.vehicle_service.GetVehicleByRegistrationNumber(
                "ASDF123"
            )
